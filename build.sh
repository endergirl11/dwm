...
cc source/drw.c source/util.c source/main.c -I /usr/X10R6/include -I /usr/include/freetype2 -I ./source -I ./headers -L /usr/X11R6/lib -lXinerama -lfontconfig -lXft -lX11 -lm -o bin/dwm
compile_status=$?
